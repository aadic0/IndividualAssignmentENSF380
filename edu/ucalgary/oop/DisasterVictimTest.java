...
public void testRemoveFamilyConnection() {
        ...
        ArrayList<FamilyRelation> expectedRelations = {relation2};
        ArrayList<FamilyRelation> originalRelations = {relation1, relation2};
...
public void testSetPersonalBelongings() {
    ...
    ArrayList<Supply> newSupplies = {one, two};
    boolean correct = true;
